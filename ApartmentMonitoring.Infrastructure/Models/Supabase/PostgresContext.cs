...
public partial class PostgresContext : DbContext
{
    ...
    public virtual DbSet<Messages20250921> Messages20250921s { get; set; }

    public virtual DbSet<Messages20250922> Messages20250922s { get; set; }

    public virtual DbSet<Messages20250923> Messages20250923s { get; set; }

    public virtual DbSet<Messages20250924> Messages20250924s { get; set; }

    public virtual DbSet<Messages20250925> Messages20250925s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Messages20250921>(entity =>
        {
            entity.HasKey(e => new { e.Id, e.InsertedAt }).HasName("messages_2025_09_21_pkey");

            entity.ToTable("messages_2025_09_21", "realtime");
        ...
        modelBuilder.Entity<Messages20250922>(entity =>
        {
            entity.HasKey(e => new { e.Id, e.InsertedAt }).HasName("messages_2025_09_22_pkey");

            entity.ToTable("messages_2025_09_22", "realtime");
        ...
        modelBuilder.Entity<Messages20250923>(entity =>
        {
            entity.HasKey(e => new { e.Id, e.InsertedAt }).HasName("messages_2025_09_23_pkey");

            entity.ToTable("messages_2025_09_23", "realtime");
        ...
        modelBuilder.Entity<Messages20250924>(entity =>
        {
            entity.HasKey(e => new { e.Id, e.InsertedAt }).HasName("messages_2025_09_24_pkey");

            entity.ToTable("messages_2025_09_24", "realtime");
        ...
        modelBuilder.Entity<Messages20250925>(entity =>
        {
            entity.HasKey(e => new { e.Id, e.InsertedAt }).HasName("messages_2025_09_25_pkey");

            entity.ToTable("messages_2025_09_25", "realtime");
        ...
        {
            entity.HasKey(e => new { e.Id, e.CreatedAt, e.MinPrice, e.MaxPrice, e.MinSize, e.MaxSize, e.Floor, e.Rooms, e.Districs, e.UserId }).HasName("subscription_pkey");
            ...
            entity.Property(e => e.Districs).HasColumnName("districs");
            entity.Property(e => e.UserId)
                .HasDefaultValueSql("auth.uid()")
                .HasColumnName("userId");

            entity.HasOne(d => d.User).WithMany(p => p.Subscription1s)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
